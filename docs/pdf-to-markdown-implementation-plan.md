...
- [ ] Prefer newest object revisions.
- [ ] Add tests for generated qpdf variants.
- [ ] Add corpus fixtures for xref stream and object stream PDFs.

### 3.2 More Filters And Encodings

- [ ] Implement LZW decode if required by corpus.
- [ ] Implement CCITT/JBIG2/JPEG/JPEG2000 metadata detection even before full
  raster support.
...
- [ ] Bad OCR overlay fixtures do not blindly trust hidden text.
- [ ] OCR can be disabled and produces a clear warning.
